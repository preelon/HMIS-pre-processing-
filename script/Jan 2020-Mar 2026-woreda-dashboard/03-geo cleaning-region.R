...
# read the hmis for sanity check before geo cleaning
combined_hmis <- readRDS("data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_general_cleaning_completed.rds")
...
dat_path = "data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_general_cleaning_completed.rds"

# path for pre-processed zone matches  
pre_path = "data/preprocessed/region_names_corrected.csv"

# path for output cleaned data  
out_path = "data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_region_cleaning_completed.rds"
