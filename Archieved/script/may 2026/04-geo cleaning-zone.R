...
dat_path = "Archieved/data/processed/may 2026/may_2026_hmis_region_cleaning_completed.rds"

# path for pre-processed zone matches  
pre_path = "Archieved/data/preprocessed/zone_names_corrected.csv"

# path for output cleaned data  
out_path = "Archieved/data/processed/april 2026/may_2026_hmis_zone_cleaning_completed.rds"
...
clean_zones <- readRDS(dat_path)

clean_zones |>
  filter(data_type=="positives")|>
  summarise(sum(value,na.rm = T)) #431506, correct
