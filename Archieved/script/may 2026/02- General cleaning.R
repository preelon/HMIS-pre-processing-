...
combined_hmis <- readRDS("Archieved/data/raw/May 2026 hmis/combined-hmis-may_2026.rds")
...
unique(combined_hmis$period) #Ginbot 2018 
...
geo_lookup <- readRDS("Archieved/data/eth-admin3-v1082-clean-id.rds")|>
  sf::st_drop_geometry()
...
saveRDS(combined_hmis, "Archieved/data/processed/may 2026/may_2026_hmis_general_cleaning_completed.rds")
