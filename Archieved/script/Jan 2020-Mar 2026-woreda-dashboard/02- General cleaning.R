...
combined_hmis <- readRDS("data/raw/Jan 2020-Mar 2026-woreda-dashboard/combined-hmis-jan-2020-mar-2026.rds")

# removing NA value rows from the dataset
...
unique(combined_hmis$period) #75 months 
...
combined_hmis |>
  ...
  summarise(total= sum(value, na.rm = T)) #28357480
...
saveRDS(combined_hmis, "data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_general_cleaning_completed.rds")

#-----------------------------END-----------------------------------------------------------
x <- readRDS("data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_general_cleaning_completed.rds")

x|>
  filter(data_type == "positives") |>
  summarise(sum(value, na.rm = T)) #28357480
