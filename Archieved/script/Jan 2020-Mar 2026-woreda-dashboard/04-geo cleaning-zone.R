...
dat_path = "data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_region_cleaning_completed.rds"

# path for pre-processed zone matches  
pre_path = "data/preprocessed/zone_names_corrected.csv"

# path for output cleaned data  
out_path = "data/processed/jan 2020-mar 2026/jan_2020_mar_2026_hmis_zone_cleaning_completed.rds"
...
write_csv(zclean$not_matched, 
          "data/processed/unmatched_zones_jan_2020_mar_2026_unmatched_zones.csv") #3 zones unmatched
...
# NOTE- at this point I have only one unmatched zone which is Afar Zone 6- acceptable
...
clean_regions |>
  filter(data_type=="positives")|>
  summarise(sum(value,na.rm = T)) #28356824, correct
