...
hmis_apr_2026 <- readRDS("data/processed/april 2026/april_mar_2026_hmis_woreda_cleaning_completed.rds")

# binding the two dats
integrated_hmis <- bind_rows(hmis_large, hmis_apr_2026)

# saving the binded dataset for the next step
saveRDS(integrated_hmis, "data/processed/april 2026/upto_apr_2026_hmis_for_app.rds")
